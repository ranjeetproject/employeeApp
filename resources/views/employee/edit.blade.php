                ...
                <div class="card-body">
                     <form method="POST" action="{{route("employee.update",[$employee->id])}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $employee->username }}" required autocomplete="username" autofocus>
